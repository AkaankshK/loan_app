              ...
              children: [
                TableRow(children: [
                  Padding(
                    ...
                    child: GestureDetector(
                      child: Image.asset(
                        "assets/HomeScreen/Personal Loan.png",
                        height: 50,
                        width: 50,
                      ),
                      onTap: () {
                        if (!isCitySet) {
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => PersonalLoanList()));
                        }
                      },
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                    child: GestureDetector(
                      child: Image.asset("assets/HomeScreen/home loan.png",
                          height: 50, width: 50),
                      onTap: () {
                        if (!isCitySet) {
                          Navigator.push(
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      child: Image.asset(
                          "assets/HomeScreen/Loan againt property.png",
                          height: 50,
                          width: 50),
                      onTap: () {
                        if (!isCitySet) {
                ...
                TableRow(children: [
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                    child: GestureDetector(
                      child: Image.asset("assets/HomeScreen/business Loan.png",
                          height: 50, width: 50),
                      onTap: () {
                        if (!isCitySet) {
                          Navigator.push(
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => BusinessLoanList()));
                        }
                      },
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                    child: GestureDetector(
                      child: Image.asset("assets/HomeScreen/credit card.png",
                          height: 50, width: 50),
                      onTap: () {
                        if (!isCitySet) {
                          Navigator.push(
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
                    child: GestureDetector(
                      child: Image.asset("assets/HomeScreen/Crdeit Report.png",
                          height: 50, width: 50),
                      onTap: () {
                        Navigator.push(
                            context,
                  ...
                  Row(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          "Unsecured Loan For personal Purpose",
                  ...
                  Row(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: 20),
                        child: Text(
                          "Unsecured Loan For Business Purpose",
                          style: TextStyle(fontSize: 15),
                        ),
                      )
                    ],
                  ...
                  Row(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          "Best Offers for various bank Credit cards",
                          style: TextStyle(fontSize: 15),
                        ),
                      )
                    ],
